...
namespace BookShop.Web.Client.Areas.FileManger.Controllers
{
    [Area("FileManger")]
    ...
    public class FileManagerController : Controller
    {
        ...
        private Connector GetConnector()
        {
          ...
          //  string requestUrl = "sImages";
            ...
            //_env.WebRootPath= .. ... wwww/files
            //_env.ContentRootPath=  đường dẫn thực dự    án
            ...
            var root = new RootVolume(rootDirectory, url, urlthumb)
            {
                ...
                Alias = "Thư mục uploads", // Beautiful name given to the root/home folder
